...
The client displays a web UI on **http://localhost:8080** if you have run it on your machine. Or you can access it at **http://<IP_ADDRESS_OF_THE_ROBOT>:8080** if you have run it on the robot.

Open this address from browser. ROS input and output topic settings for text input and output topics can be configured from the web UI by pressing the settings button. Send a question to your ROS EmbodiedAgent and you should get a the reply generated by the Llava model.

![Demo screencast](https://github.com/user-attachments/assets/23a6af7a-7479-4f31-809b-fc40630d3ba3)
